      ...
      <div id="form">
        <form onSubmit="sendData(event)" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="horodatage" name="Horodatage" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="SOG" name="SOG" required>
                    </div>
                    <div class="mb-3">
                        <label for="COG" class="create-div">COG </label>
                        <input type="number" class="form-control" id="COG" name="COG" required>
                    </div>
                    <div class="mb-3">
                        <label for="heading" class="create-div">Cap réel </label>
                        <input type="number" class="form-control" id="heading" name="Heading" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="draft" name="Draft" required>
                    </div>
                    <div id="submitData">
